...
typedef struct _pro_platform_id *    pro_platform_id;
...
typedef cl_uint             pro_platform_info;
...
/* pro_platform_info */
#define pro_PLATFORM_PROFILE                         0x0900
#define pro_PLATFORM_VERSION                         0x0901
#define pro_PLATFORM_NAME                            0x0902
#define pro_PLATFORM_VENDOR                          0x0903
#define pro_PLATFORM_EXTENSIONS                      0x0904
#ifdef CL_VERSION_2_1
#define pro_PLATFORM_HOST_TIMER_RESOLUTION           0x0905
#endif
#ifdef CL_VERSION_3_0
#define pro_PLATFORM_NUMERIC_VERSION                 0x0906
#define pro_PLATFORM_EXTENSIONS_WITH_VERSION         0x0907
#endif
...
clGetPlatformIDs(cl_uint          num_entries,
                 pro_platform_id * platforms,
                 cl_uint *        num_platforms) CL_API_SUFFIX__VERSION_1_0;

extern CL_API_ENTRY cl_int CL_API_CALL
clGetPlatformInfo(pro_platform_id   platform,
                  pro_platform_info param_name,
...
/* Device APIs */
extern CL_API_ENTRY cl_int CL_API_CALL
clGetDeviceIDs(pro_platform_id   platform,
...
extern CL_API_ENTRY cl_int CL_API_CALL
clUnloadPlatformCompiler(pro_platform_id platform) CL_API_SUFFIX__VERSION_1_2;
 ...
 */
extern CL_API_ENTRY void * CL_API_CALL
clGetExtensionFunctionAddressForPlatform(pro_platform_id platform,
...
#include "pro_platform.h"
#pragma message("Include More please.")
